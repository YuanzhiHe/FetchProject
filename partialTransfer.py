...
model2.critic.q_networks[0][0].weight.data[:26] = original_first_layer[0].weight.data[:26]
model2.critic.q_networks[1][0].weight.data[:26] = original_first_layer[1].weight.data[:26]
...
model.save("./model/PartialPushToSlide_tqc_her.pkl")
