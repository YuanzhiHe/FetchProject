...
model2 = TQC(
    ...
    tensorboard_log="./tensorboard/FetchPushTest_TQC_HER-v2/"
)
...
# model2.critic.q_networks[0][0] = torch.nn.Linear(35, 512)
# model2.critic.q_networks[1][0] = torch.nn.Linear(35, 512)
# model2.critic_target.q_networks[0][0] = torch.nn.Linear(35, 512)
# model2.critic_target.q_networks[1][0] = torch.nn.Linear(35, 512)
...
model2.critic_target.q_networks[0][0].weight.data[:,:20] = original_first_layer2[0].weight.data
model2.critic_target.q_networks[1][0].weight.data[:,:20] = original_first_layer2[1].weight.data
...
model2.save("./model/FetchPushTest_tqc_her.pkl")
