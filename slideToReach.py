...
env_name2 = "FetchSlide-v2"
env2 = gym.make(env_name2)

env = Monitor(env)

model = TQC.load("./model/FetchSlide_tqc_her.pkl", env=env2)
model2 = TQC(
    env=env,
    ...
    tensorboard_log="./tensorboard/FetchSlideToReach_TQC_HER-v2/"
)
...
model2.save("./model/FetchSlideToReach_tqc.pkl")